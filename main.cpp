...
const static char DEVICE_NAME[] = "Fuck2023";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _heartrate_service(_ble, _heartrate_value, HeartRateService::LOCATION_FINGER),
...
private:
    ...
    void update_sensor_value()
    {
        ...
        _magneto_service.updateMagneto(_pDataXYZ[0], _pDataXYZ[1], _pDataXYZ[2]);
    }
